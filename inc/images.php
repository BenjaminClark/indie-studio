...
function indie_studio_gallery_customizer( $output, $attr, $instance ) {
	...
	foreach ( $attachments as $id => $attachment ) {
        ...
        $image_output = indie_studio_attachment_image( $id, $instance, $atts['size'], $attr );
...
add_filter( 'post_gallery', 'indie_studio_gallery_customizer', 10, 3 );



function indie_studio_attachment_image( $id, $gallery_id, $size, $attr ){
