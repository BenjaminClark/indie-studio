<?php 
/** 
 * Template Name: Parent Page - Extended
 * 
 * The template for displaying the parent page. This is used to display all of its sub pages within it. The only difference to the standard parent page is that it includes an excerpt on the module
 * 
            ...
            if ( have_posts()  ) { 
                ...
                <div id="ajax-post-wrap" class="grid-container below-text masonry basic">
                    ...
                    while ( have_posts() ) : the_post();
                        ...
                        get_template_part( 'template-parts/post/module', 'child-extended' );
